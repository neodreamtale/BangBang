...
# Ensure uploads directory exists in the runtime image and is writable by UID 1001
RUN mkdir -p /app/uploads && chown -R 1001:1001 /app/uploads && chmod 770 /app/uploads
